...
function OnLoad()
Menu()
                  print("<b><font color=\"#6699FF\">>CSHZed: Zaladowany :)   <</font>")
		print("<b><font color=\"#6699FF\">>Skrypt wykonal: AjGoRe  <</font>")
		print("<b><font color=\"#6699FF\">>CSHZed: Powodzenia      <</font>")
		print("<b><font color=\"#6699FF\">>------------------------<</font>")
		print("<b><font color=\"#6699FF\">>UWAGA !!!               <</font>")
		print("<b><font color=\"#6699FF\">>Skrypt jest w fazie Beta<</font>")
		print("<b><font color=\"#6699FF\">>Prosze zglaszac wszystkie problemy<</font>")
...
if not target then return end
	...
	if WREADY and GetDistance(target) < WRANGE  and Configzedex.comboset.zedexw and Configzedex.combozedex then
		...
		if WREADY and GetDistance(target) < WRANGE  and Configzedex.comboset.zedexw and Configzedex.combozedex and WClone then
			CastSpell(_W, target.x, target.z)
		end
